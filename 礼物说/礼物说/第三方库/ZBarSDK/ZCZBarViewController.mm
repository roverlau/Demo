...
-(void)createView{
    ...
    if (self.view.frame.size.height<500) {
        ...
        bgImageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, 64, [UIScreen mainScreen].bounds.size.width, self.view.frame.size.height-64-100)];
    ...
    UILabel * label = [[UILabel alloc] initWithFrame:CGRectMake(0, 350, [UIScreen mainScreen].bounds.size.width, 40)];
    ...
    _line = [[UIImageView alloc] initWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width/2 - 110, 90, 220, 2)];
    _line.image = [UIImage imageNamed:@"qrcode_scan_light_green.png"];
    [bgImageView addSubview:_line];
    
    
    //下方相册
    UIImageView*scanImageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, bgImageView.frame.size.height+64, [UIScreen mainScreen].bounds.size.width, 100)];
    ...
    for (int i=0; i<unSelectImageNames.count; i++) {
        ...
        button.frame=CGRectMake([UIScreen mainScreen].bounds.size.width/3*i, 0, [UIScreen mainScreen].bounds.size.width/3, 100);
    ...
    //假导航
    UIImageView*navImageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 64)];
    navImageView.image=[UIImage imageNamed:@"qrcode_scan_bar.png"];
    navImageView.userInteractionEnabled=YES;
    [self.view addSubview:navImageView];
    UILabel*titleLabel=[[UILabel alloc]initWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width/2-32,20 , 64, 44)];
    ...
    self.view.backgroundColor = [UIColor colorWithRed:50/256.0 green:51/266.0 blue:52/256.0 alpha:1.0];
}
...
-(void)animation1
{
    ...
    [UIView animateWithDuration:2 animations:^{
        ...
        _line.frame = CGRectMake([UIScreen mainScreen].bounds.size.width/2 - 110, 70+200, 220, 2);
    }completion:^(BOOL finished) {
        [UIView animateWithDuration:2 animations:^{
            _line.frame = CGRectMake([UIScreen mainScreen].bounds.size.width/2 - 110, 90, 220, 2);
        }];
